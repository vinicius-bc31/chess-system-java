...
public class ChessMatch {
	...
	private Board board;
	private boolean check; // check starts with false in the constructor, it is not necessary to put it
							// there
	private boolean checkMate; // checkMate starts with false in the constructor, it is not necessary to put it
								// there
	private ChessPiece enPassantVunerable; // enPassantVunerable starts with null in the constructor, it is not
											// necessary to put it there
	...
	private void validateSourcePosition(Position position) {
		if (!board.thereIsAPiece(position)) {
			throw new ChessException("There is no piece os source position");
		}
	...
	private void nextTurn() { // change turn
		turn++;
